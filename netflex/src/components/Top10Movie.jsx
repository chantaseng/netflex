        ...
        >
          <div className="flex items-center justify-center">
            ...
            <img
              ...
              alt={movie?.title}
            />
            <div className="absolute left-10 top-0 h-full w-full text-white  opacity-0 hover:bg-black/80 hover:opacity-100">
              ...
              <p onClick={saveToWatchList}>
                {favorite ? (
                  <FaHeart className="heart-icon absolute right-[68px] top-7 text-gray-400" />
                ) : (
                  <FaRegHeart className="heart-icon absolute right-[68px] top-7 text-gray-400" />
                )}
              </p>
            </div>
          </div>
